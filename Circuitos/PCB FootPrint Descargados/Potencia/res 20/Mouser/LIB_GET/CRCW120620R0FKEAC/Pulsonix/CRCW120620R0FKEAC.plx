...
//1465395/248335/2.46/2/5/Resistor
...
(library Library_1
	...
	(symbolDef "CRCW120620R0FKEAC" (originalName "CRCW120620R0FKEAC")
	...
	(compDef "CRCW120620R0FKEAC" (originalName "CRCW120620R0FKEAC") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CRCW120620R0FKEAC"))
		...
		(attr "Mouser Part Number" "71-CRCW120620R0FKEAC")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=71-CRCW120620R0FKEAC")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "CRCW120620R0FKEAC")
		(attr "Description" "Standard Thick Film Chip Resistors value 20R0 ohm.")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/CRCW120620R0FKEAC.pdf")
		(attr "<Component Height>" "0.6")
		(attr "<STEP Filename>" "CRCW120620R0FKEAC.stp")
